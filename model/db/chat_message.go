...
type ChatMessage struct {
	...
	SenderType   int8           `gorm:"column:sender_type;type:tinyint;comment:发送者类型 1候选人 2hr;not null;" json:"sender_type"`                                // 发送者类型 1候选人 2hr
	MessageType  int8           `gorm:"column:message_type;type:tinyint;comment:1文本 2图片 3文件 4简历 5岗位卡片 6面试邀请 7系统消息;not null;default:1;" json:"message_type"` // 1文本 2图片 3文件 4简历 5岗位卡片 6面试邀请 7系统消息
